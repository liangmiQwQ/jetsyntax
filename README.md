...
The latest complete, correctly wired official-suite baseline was captured at [`f5f152b`](https://github.com/liangmiQwQ/jetsyntax/commit/f5f152b) in [GitHub Actions run 29883049210](https://github.com/liangmiQwQ/jetsyntax/actions/runs/29883049210):

| Suite                 | Passed | Failed | Unsupported | Executed | Skipped |
| --------------------- | -----: | -----: | ----------: | -------: | ------: |
| Test262               | 99,903 |  2,694 |           0 |  102,597 |       0 |
| TypeScript            | 11,553 |  9,189 |           0 |   20,742 |       0 |
| Babel parser fixtures |  3,555 |  1,337 |       1,044 |    5,936 |       0 |
