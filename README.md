...
The latest complete, correctly wired official-suite baseline was captured at [`483fcf3`](https://github.com/liangmiQwQ/jetsyntax/commit/483fcf3) in [GitHub Actions run 29884333138](https://github.com/liangmiQwQ/jetsyntax/actions/runs/29884333138):

| Suite                 | Passed | Failed | Unsupported | Executed | Skipped |
| --------------------- | -----: | -----: | ----------: | -------: | ------: |
| Test262               | 99,903 |  2,694 |           0 |  102,597 |       0 |
| TypeScript            | 11,607 |  9,135 |           0 |   20,742 |       0 |
| Babel parser fixtures |  3,558 |  1,334 |       1,044 |    5,936 |       0 |
